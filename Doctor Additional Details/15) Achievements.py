...
driver.find_element(By.XPATH, "//*[@id='pr_id_15_header_0']").click()
driver.implicitly_wait(5)
...
actions.send_keys(Keys.TAB).send_keys("21/08/2023")
driver.find_element(By.XPATH, "//textarea[@name='Remarks']").send_keys("Achievements")
driver.find_element(By.XPATH, "//img[@class='uploaded-image']").click()

pyautogui.typewrite(r'/home/tipl-pc-21/Desktop/Images/1.png')
