...
driver.find_element(By.XPATH, "//*[@id='pr_id_11_header_0']").click()
driver.implicitly_wait(5)

driver.find_element(By.XPATH, "//span[@class='btn btn-primary mb-3 float-end']").click()
driver.implicitly_wait(5)

driver.find_element(By.XPATH, "//input[@name='PatientReferencesSourceDoctorName']").send_keys("KKK")
actions.send_keys(Keys.TAB).send_keys(Keys.DOWN).send_keys(Keys.ENTER).perform()
driver.find_element(By.XPATH, "//input[@name='PatientReferencesSourceHospitalName']").send_keys("SMS")
actions.send_keys(Keys.TAB).send_keys(Keys.DOWN).send_keys(Keys.ENTER).perform()
...
driver.find_element(By.XPATH, "//input[@name='PatientReferencesSourceHospitalAddressLine1']").send_keys("SMS")
driver.find_element(By.XPATH, "//input[@name='PatientReferencesSourceHospitalAddressLine2']").send_keys("SMS")
actions.send_keys(Keys.TAB).send_keys(Keys.DOWN).send_keys(Keys.ENTER).perform()
time.sleep(1)
actions.send_keys(Keys.TAB).send_keys(Keys.DOWN).send_keys(Keys.ENTER).perform()
